...
export default function ProfileUserMsgScreen() {
        ...
        return (
            ...
            >
                ...
                <VStack style={{ width: "100%", marginTop: 10 }}>
                    <Text className="text-md mt-10 font-normal   text-typography-900">
                        Mais Influente da América Latina pela Blomberg \n kkdk
                    </Text>

                    <Text className="text-md mt-2 font-normal   text-typography-900">
    ...
    const TitleContainer = (title) => {
        return (
            <Heading style={{ marginTop: 30, marginBottom: 5 }} size="lg">
                {title.name}
            </Heading>
        );
    };
    ...
    const AboutProfile = (title) => {
        return (
            <VStack>
                ...
                <Text size="lg" style={{ marginTop: 5, color: "#00A8FF" }}>
                    Ver mais
                </Text>
    ...
    const SocialLinks = (title) => {
        return (
            <VStack className="ml-4 mr-4">
                ...
                <Text size="lg" style={{ marginTop: 1 }}>
                    {title.username}
                </Text>
