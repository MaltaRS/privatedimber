...
export default function SharedDimberScreen() {
    ...
    const ContainerGiftTitle = () => (
        <VStack alignItems="center" justifyContent="center" mt={10} width="100%">
            <Image style={{ width: 100, height: 122, marginTop: 24 }} source={icongift} />
    ...
    const ContainerQRcode = () => (
        <VStack alignItems="center" justifyContent="center" mt={40} width="100%">
            ...
            <Image style={{ width: 120, height: 120, margin: 20 }} source={iconqrcode} />
            
            <HStack alignItems="center" justifyContent="center">
                <TouchableOpacity onPress={compartilharCodigo}>
                    <Text bold size="sm"  mb={6} style={{ color: "#00A8FF", marginLeft: 6 }}>Salvar QR Code</Text>
                </TouchableOpacity>
                <MaterialIcons name="share" size={20} color="#00A8FF" style={{ marginLeft: 8 }} />
            </HStack>

            <VStack alignItems="center" justifyContent="center">
                <Text size="15" bold mt={16}>Ficou com alguma dúvida?</Text>
            </VStack>
    ...
    return (
        <BaseContainer>
            ...
            <ContainerGiftTitle />
            <ContainerQRcode />
            <ButtonPadrao name="Compartilhar código" onPress={compartilharCodigo} />
