...
export default function SharedDimberScreen() {
                 ...
                 alignItems: 'center', width: '100%', justifyContent: 'space-between', marginTop: 20 
                  ...
                  <HStack style={{alignItems: 'center', justifyContent: 'space-between', }} >
                      ...
                      <VStack space="xs" style={{marginLeft: 12}}  >
                          ...
                          <Text size="lg" style={{color: '#999'}} >{notific.description}</Text>
                      </VStack>
                  </HStack>
  ...
  const CodigVerific = () => {
    ...
    <View
        ...
        backgroundColor: '#f9f9f9', alignItems: 'center', justifyContent: 'center', borderRadius: 14
    }} >
            <HStack
             style={{
               ...
               alignItems: 'center', width: '100%', justifyContent: 'space-between', 
                ...
                <Text bold size="xl"  >Seu Codigo de Verificação</Text>
                <MaterialIcons name="content-copy" size={24} color="#00A8FF" style={{marginLeft: 15}} />

                </HStack>
            </HStack>
            <Text bold size="xl"  >979848389</Text>
       ...
       <VStack className="mt-5 p-5" >
        ...
        <VStack 
            ...
            <Heading 
                ...
                }}  size="2xl">Compartilhe o Dimber e ganhe beneficios</Heading>
                <AntDesign name="gift" size={74} color="#00A8FF" />

               
             <Text size="xl"  >Convide seus amigos e aproveite vantagens exclusivas</Text>
             <CodigVerific />

        </VStack>

        <VStack 
            style={{width: '100%', alignItems: 'center', justifyContent: 'center', marginTop: 30}}
            className="mt-5 " >
            <Heading 
                style={{
                alignItems: 'center', justifyContent: 'center', textAlign: 'center'
                }}  size="2xl">Compartilhe com QR Code
            </Heading>
            <AntDesign name="qrcode" size={120} color="black" style={{marginTop: 20}} />

           <Text bold size="sm" style={{color: '#00A8FF', marginLeft: 6}} >Salvar QR Code</Text>
            <Text size="xl"  >Ficou com alguma duvida ? </Text>
            <Text size="xl"  >Clique aqui e leia os termos e condições</Text>


            
            <Box className="flex-col sm:flex-row mt-20" >
                <Button style={{backgroundColor: '#00A8FF', borderRadius: 40, marginTop: 20  }} 
                 className="px-9 h-[70px] mr-0 mb-3 sm:mr-3 sm:mb-0 sm:flex-1 "  >
                <ButtonText size="xl">Compartilhar Codigo</ButtonText>
                </Button>
            </Box>
        </VStack>
                ...
                <Text bold size="sm"  >Clique aqui e leia os</Text>
                <Text bold size="sm" style={{color: '#00A8FF', marginLeft: 6}} >termos e condições</Text>
