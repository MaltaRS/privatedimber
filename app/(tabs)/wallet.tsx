...
import { Text, VStack, HStack, Heading } from "@/gluestackComponents";
...
const WalletScreen = () => {
    ...
    const HeaaderInfosWallet = () => {
        return (
            ...
            >
                ...
                >
                    <Heading size="4xl">R$ 7,023,99</Heading>
                    <AntDesign
                        name="circledowno"
                        size={17}
                        color="#999"
                ...
                <HStack alignItems="center" gap="$1">
                    ...
                    <Text bold fontFamily="$heading" size="md" lineHeight="$md">
                        1.400,00S
                    </Text>
                </HStack>
            </VStack>
    ...
    const MiniButtonsWallet = (title) => {
        return (
            ...
            >
                <Image source={title.icon} style={{ width: 50, height: 50 }} />
        ...
        return (
            <VStack className="mt-5 p-2">
                ...
                >
                    ...
                    >
                        <Text color="#00A8FF">Ver extratos</Text>
                    </TouchableOpacity>
                </HStack>
