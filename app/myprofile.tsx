    ...
    const ComponentProfileStatistics = (title) => {
        ...
        <View 
           style={{
              ...
              padding: 6, margin: 2, borderRadius: 10, borderWidth: 1, borderColor: '#999' 
            }} >
                <HStack style={{alignItems: 'center'}}  >
                   <FontAwesome name={title.nameicon} size={20} color="black" style={{padding: 8}} />
                   <Text bold size="sm" >{title.number}</Text>
                </HStack>
            <Text bold size="sm" >{title.name}</Text>
         </View>   
        )
        ...
        <BaseContainer
         ...
         style={{flex: 1, backgroundColor: '#FFF'}}  >
            <ScrollView>
                ...
                <View 
                  style={{flex: 1, marginTop: 60 , padding: 1}} >
